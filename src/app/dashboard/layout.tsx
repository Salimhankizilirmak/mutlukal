...
import { Activity, MonitorDot, SendToBack, ShieldAlert, FileText, Users, Smartphone, Flower, Briefcase, Scan } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-[#09090b]">
      ...
      <aside className="hidden md:flex w-64 bg-[#18181b]/50 border-r border-zinc-800/50 backdrop-blur-xl flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link href="/dashboard/gs1/scanner" className="flex items-center gap-3 text-zinc-400 hover:text-emerald-400 hover:bg-zinc-800/30 p-3 rounded-lg transition-all"><Scan size={20} /> Terminal Okuyucu</Link>
          ...
          <Link href="/dashboard/b2b" className="flex items-center gap-3 text-indigo-400 hover:bg-indigo-400/10 p-3 rounded-lg transition-all"><Briefcase size={20} /> B2B Siparişler</Link>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#18181b]/95 backdrop-blur-xl border-t border-zinc-800/50 z-50">
        <div className="flex overflow-x-auto no-scrollbar items-center justify-start px-4 py-3 gap-6">
          ...
          <Link href="/dashboard/gs1/scanner" className="flex flex-col items-center gap-1 text-zinc-400 hover:text-emerald-400 shrink-0"><Scan size={22} /><span className="text-[9px] font-medium">Okuyucu</span></Link>
          ...
          <Link href="/dashboard/b2b" className="flex flex-col items-center gap-1 text-indigo-500 hover:text-indigo-400 shrink-0"><Briefcase size={22} /><span className="text-[9px] font-medium">B2B</span></Link>
